...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha384-Hj0NNIaQ3e75LjPhaxG9ST0AVgK40zBZRnAZLRB4Ov4e3Og78PMEYz3zJshd+fsJ" crossorigin="anonymous">
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									...
									<ul class="nav nav-treeview">
										<li class="nav-item">
											<a href="<?php echo base_url().'nuevo_categorias'?>" class="nav-link">
							...
							<ul class="nav nav-treeview">
								...
								<ul class="nav nav-treeview">
									<li class="nav-item">
										<a href="<?php echo base_url().'nuevo_episodios'?>" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Nuevo</p>
										</a>
									</li>
							...
							<ul class="nav nav-treeview">
								...
								<ul class="nav nav-treeview">
									<li class="nav-item">
										<a href="<?php echo base_url().'nuevo_peliculas'?>" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Nuevo</p>
										</a>
									</li>
							...
							<ul class="nav nav-treeview">
								...
								<ul class="nav nav-treeview">
									<li class="nav-item">
										<a href="<?php echo base_url().'nuevo_portadas'?>" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Nuevo</p>
										</a>
									</li>
							...
							<ul class="nav nav-treeview">
								...
								<ul class="nav nav-treeview">
									<li class="nav-item">
										<a href="<?php echo base_url().'nuevo_series'?>" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Nuevo</p>
										</a>
									</li>
							...
							<ul class="nav nav-treeview">
								...
								<ul class="nav nav-treeview">
									<li class="nav-item">
										<a href="<?php echo base_url().'nuevo_temporadas'?>" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Nuevo</p>
										</a>
									</li>
							...
							<ul class="nav nav-treeview">
								...
								<ul class="nav nav-treeview">
									<li class="nav-item">
										<a href="<?php echo base_url().'nuevo_tvshow'?>" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Nuevo</p>
										</a>
									</li>
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									...
									<a href="<?php echo base_url().'index_episodios'?>" class="nav-link">
									...
									<a href="<?php echo base_url().'index_temporadas'?>" class="nav-link">
										<i class="far fa-file-video nav-icon"></i>
										<p>Temporadas</p>
									</a>
				...
				<div class="container mt-4">
					<div class="card">
						<div class="card-header text-white bg-primary mb-3">
							<a href="nuevo_categorias" button type="button" class="btn btn-danger">Nuevas Categorias</a>
						</div>
						<div class="card-body">
								...
								<tbody>
									...
									?>
										...
										<tr>
											...
											<td>
												<a class="btn btn-warning" href="<?php echo base_url('borrar_categorias?id='. $value['id_categoria']);?>">
													<i class="fas fa-eraser"></i>
												</a>
												<a class="btn btn-info" href="<?php echo base_url('editar_categorias?id='. $value['id_categoria']);?>">
