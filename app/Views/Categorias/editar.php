									...
									<ul class="nav nav-treeview">
										<li class="nav-item">
											<a href="<?php
														...
														echo base_url() . 'nuevo_categorias' ?>" class="nav-link">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="card-body">
					...
					echo "<br>";
					$base = base_url();
					echo form_open('/modificar_categorias');
					...
					if (!empty($categorias)) {
						...
						if (isset($Codigo)) {
							...
							echo "<br>";
							echo form_input(array('name' => 'txtNombre', 'placeholder' => 'Ingrese el nombre', 'class' => 'form-control', 'value' => $nombre));
							echo "<br>";
							echo form_button(array('name' => 'btnmodificar', 'type' => 'submit', 'class' => 'btn btn-primary', 'content' => 'Modificar'));
						}
					}
					echo form_close();
					?>
