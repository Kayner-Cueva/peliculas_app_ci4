			...
			<section class="content">
				...
				<div class="card-body">
					<?php
                        echo "<br>";
                        $base = base_url();
                        echo form_open('/modificar_usuarios');
                        echo form_label('Codigo', 'txtCodigo');
                        //<label></label>
                            echo "<br>";
                            $Codigo = 0;
                            foreach ($usuario as $value) {
                                $Codigo = $value['id_usuario'];
                                $USUNOMBRE = $value['nombre_completo'];
                                $USUCORREO = $value['correo'];
                                $USUUSUARIO = $value['usuario'];
                                $USUCLAVE = $value['contrasena'];
                                $USUROL = $value['rol'];
                            }
                                ...
                                echo "<br>";
                                echo form_input(array('name' => 'txtCorreo', 'placeholder' => 'Ingrese la operaciones', 'class' => 'form-control', 'value' => $USUCORREO));
                                echo "<br>";
                                echo form_label('Usuario', 'Usuario');
                                echo "<br>";
                                echo form_input(array('name' => 'txtUsuarios', 'placeholder' => 'Ingrese la operaciones', 'class' => 'form-control', 'value' => $USUUSUARIO));
                                echo "<br>";
                                echo form_label('Contrasena', 'Contrasena');
                                echo "<br>";
                                echo form_input(array('name' => 'txtClave', 'placeholder' => 'Ingrese el estado', 'class' => 'form-control', 'value' => $USUCLAVE));
                                echo "<br>";
                                echo form_label('Rol', 'Rol');
                                echo "<br>";
                                echo form_input(array('name' => 'txtRol', 'placeholder' => 'Ingrese el estado', 'class' => 'form-control', 'value' => $USUROL));
                                echo "<br>";
