					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Eliminar Peliculas</li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
				...
				<div class="card-body">
					<?php
                        ...
                        if (!empty($peliculas)) {
							...
							echo "<br>";
							if (isset($Codigo)) {
								echo form_open('/eliminar_peliculas');
								echo "<br>";
                                ...
                                echo "<br>";
                                echo form_button(array('name' => 'btnEliminar', 'type' => 'submit', 'class' => 'btn btn-primary', 'content' => 'Eliminar', 'onclick' => "return confirm('¿Estás seguro de que quieres eliminar este elemento?')"));
								// Botón de regreso
