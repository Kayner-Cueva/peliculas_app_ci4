				...
				<div class="container mt-4">
					<div class="card">
						<div class="card-header text-white bg-primary mb-3">
							<a href="<?php echo base_url() . 'nuevo_peliculas' ?>" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#nuevoModal">Registro Peliculas</a>
						</div>
						<div class="card-body">
							<table id="example" class="table table-striped table-hover dt-responsive display nowrap table-bordered" cellspacing="0">
								...
								<tbody>
									...
									?>
										...
										<tr>
											<th><?php echo $value['id_peliculas'] ?></th>
											...
											<td><?php echo $value['url_pelicula']; ?></td>
											<td><a class="btn btn-warning" href="<?php echo base_url('borrar_peliculas?id='. $value['id_peliculas']);?>">
													<i class="fas fa-eraser"></i>
												</a>
												<a class="btn btn-info" href="<?php echo base_url('editar_peliculas?id='. $value['id_peliculas']);?>">
