		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Actualizar Peliculas</li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card-body">
					...
					echo "<br>";
					$base = base_url();
					echo form_open('/modificar_peliculas');
					echo form_label('Codigo', 'txtCodigo');
					if (!empty($peliculas)) {
						// Suponiendo que solo se está editando un registro, no se necesita un bucle
						$Codigo = $peliculas['id_peliculas'];
						$portada = $peliculas['portada'];
						$fondo = $peliculas['fondo'];
						$logo = $peliculas['logo'];
						$titulo = $peliculas['titulo'];
						$descripcion = $peliculas['descripcion'];
						$categoria = $peliculas['categorias'];
						$creador = $peliculas['creador'];
						$fecha = $peliculas['fecha_estreno'];
						$duracion = $peliculas['duracion'];
						$urlpeliculas = $peliculas['url_pelicula'];
						echo "<br>";
						if (isset($Codigo)) {
							...
							echo "<br>";
							echo form_input(array('name' => 'txtPortada', 'placeholder' => 'Ingrese la Portada', 'class' => 'form-control', 'value' => $portada));
							echo "<br>";
							echo form_label('Fondo', 'Fondo');
							echo "<br>";
							echo form_input(array('name' => 'txtFondo', 'placeholder' => 'Ingrese el fondo', 'class' => 'form-control', 'value' => $fondo));
							echo "<br>";
							echo form_label('Logo', 'Logo');
							echo "<br>";
							echo form_input(array('name' => 'txtLogo', 'placeholder' => 'Ingrese el Logo', 'class' => 'form-control', 'value' => $logo));
							echo "<br>";
							echo form_label('Titulo', 'Titulo');
							echo "<br>";
							echo form_input(array('name' => 'txtTitulo', 'placeholder' => 'Ingrese el Titulo', 'class' => 'form-control', 'value' => $titulo));
							echo "<br>";
							echo form_label('Descripcion', 'Descripcion');
							echo "<br>";
							echo form_input(array('name' => 'txtDescripcion', 'placeholder' => 'Ingrese la Descripcion', 'class' => 'form-control', 'value' => $descripcion));
							echo "<br>";
							echo form_label('Categorias', 'Categorias');
							echo "<br>";
							echo form_input(array('name' => 'txtCategorias', 'placeholder' => 'Ingrese las Categorias', 'class' => 'form-control', 'value' => $categoria));
							echo "<br>";
							echo form_label('Creador', 'Creador');
							echo "<br>";
							echo form_input(array('name' => 'txtCreador', 'placeholder' => 'Ingrese el Creador', 'class' => 'form-control', 'value' => $creador));
							echo "<br>";
							echo form_label('Fecha Estreno', 'Fecha Estreno');
							echo "<br>";
							echo form_input(array('name' => 'txtFecha', 'placeholder' => 'Ingrese la Fecha de Estreno', 'class' => 'form-control', 'value' => $fecha));
							echo "<br>";
							echo form_label('Duracion', 'Duracion');
							echo "<br>";
							echo form_input(array('name' => 'txtDuracion', 'placeholder' => 'Ingrese la duracion de la peliculas', 'class' => 'form-control', 'value' => $duracion));
							echo "<br>";
							echo form_label('Pelicula', 'Pelicula');
							echo "<br>";
							echo form_input(array('name' => 'UrlPeliculas', 'placeholder' => 'Ingrese la url de la Peliculas', 'class' => 'form-control', 'value' => $urlpeliculas));
							echo "<br>";
							echo form_button(array('name' => 'btnGuardar', 'type' => 'submit', 'class' => 'btn btn-primary', 'content' => 'Guardar', 'onclick' => "return confirm('¿Estás seguro de que quieres modificar este elemento?')"));
							// Botón de regreso
							echo "<a href='" . previous_url() . "' class='btn btn-secondary'>Regresar</a>";
						}
					}
					echo form_close();
					?>
