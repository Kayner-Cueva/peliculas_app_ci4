    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="nuevoModalLabel">Registro Peliculas</h5>
            ...
            <div class="modal-body">
                <?php
                    echo "<br>";
                    $base = base_url();
                    echo form_open('/guardar_peliculas');
                    ...
                    echo "<br>";
                    echo form_input(array('name' => 'txtDuracion', 'placeholder' => 'Ingrese la duracion de la peliculas', 'class' => 'form-control'));
                    echo "<br>";
                    echo form_label('Pelicula', 'Pelicula');
                    echo "<br>";
                    echo form_input(array('name' => 'UrlPeliculas', 'placeholder' => 'Ingrese la url de la Peliculas', 'class' => 'form-control'));
                    echo "<br>";
