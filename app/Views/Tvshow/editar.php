				...
				<div class="card-body">
					...
					if (!empty($tvshow)) {
						...
						if (isset($Codigo)) {
							...
							echo "<br>";
							echo form_input(array('name' => 'txtLogo', 'placeholder' => 'Ingrese la Logo de la peliculas', 'class' => 'form-control', 'value' => $logo));
							echo "<br>";
							echo form_label('Canal', 'Canal');
							echo "<br>";
							echo form_input(array('name' => 'txtCanal', 'placeholder' => 'Ingrese la Canal de la peliculas', 'class' => 'form-control', 'value' => $canal));
							echo "<br>";
							echo form_label('Show', 'Show');
							echo "<br>";
							echo form_input(array('name' => 'UrlShow', 'placeholder' => 'Ingrese la url de la Canal', 'class' => 'form-control', 'value' => $urlshow));
							echo "<br>";
