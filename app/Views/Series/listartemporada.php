				...
				<div class="container mt-4">
					<div class="card">
						<div class="card-header text-white bg-primary mb-3">
							<a href="<?php echo base_url() . 'listar' ?>" class="btn btn-primary">Lista Series</a>
							<a href="<?php echo base_url() . 'nuevo' ?>" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#nuevoModal">Registro Temporadas</a>
						...
						<div class="card-body">
							<table id="example" class="table table-striped table-hover dt-responsive display nowrap table-bordered" cellspacing="0">
								...
								<tbody>
									...
									<?php
									foreach ($temporada as $value) {
									?>

										<tr>
											<th><?php echo $value['id_temporada'] ?></th>
						...
						<?php include 'nuevotemporada.php'; ?>
