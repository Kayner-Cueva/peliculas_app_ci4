		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Actualizar Series</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">Actualizar Series</li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
                ...
                <?php
					...
					if (!empty($series)) {
						...
						$creador = $series['creador'];
						$fecha = $series['fecha_estreno'];
						...
						if (isset($Codigo)) {
							...
							echo "<br>";
							echo form_input(array('name' => 'txtTemporada', 'placeholder' => 'Ingrese la Temporada de la peliculas', 'class' => 'form-control', 'value' => $temporada));
							echo "<br>";
